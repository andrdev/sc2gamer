...
public class AlarmCreatorService extends IntentService {
    ...
    final static int CLICK = 2;
    final static String ALARM_EVENT = "alarm_event";
    ...
    private void setAlarm(int id, int time) {
        String pre = PreferenceManager.getDefaultSharedPreferences(this).getString("pref_alarm_time", "");
        Log.d("DREEtime", " serv "+pre);
        long alarmTime = System.currentTimeMillis() + 2000L;
